...
axes[0, 0].hist(samples_phy, bins=1000, alpha=0.5, color='#76c893', density=True, label='Samples (n = 30,000)')
axes[0, 0].legend()
...
axes[0, 1].hist(samples_cdom, bins=1000, alpha=0.5, color='#76c893', density=True, label='Samples (n = 30,000)')
axes[0, 1].legend()
...
axes[1, 0].hist(samples_nap, bins=1000, alpha=0.5, color='#76c893', density=True, label='Samples (n = 30,000)')
axes[1, 0].legend()
...
axes[1, 0].set_xlabel('NAP concentration (g/$\mathregular{m^3}$)')
...
axes[1, 1].hist(samples_wind, bins=1000, alpha=0.5, color='#76c893', density=True, label='Samples (n = 30,000)')
axes[1, 1].legend()
...
axes[2, 0].hist(samples_depth, bins=1000, alpha=0.5, color='#76c893', density=True, label='Samples (n = 30,000)')
axes[2, 0].legend()
